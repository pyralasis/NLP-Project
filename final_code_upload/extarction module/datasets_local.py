...
# primary code: tag_sentiment_data()  this script takes in the raw jso dataset and converts to the BIO tagged format we need for trianing 
...
def tokenizer_custom(text):
    return  tokenizer(
            ...
            padding=True,  #True:dynamic padding? adjust?
